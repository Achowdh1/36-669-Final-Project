...
plot(x = expr_pca[,4],
     ...
     type = "p",
     pch = 16,
     xlab = "Fourth Principal Component",
...
```{r}
tsne.out <- Rtsne::Rtsne(expr_mat, dims = 3, perplexity = 30, pca = TRUE, initial_dims = 50)
plot(tsne.out$Y[,2],tsne.out$Y[,3], xlab = "tSNE_2", ylab = "tSNE_3",type = "p", pch = 16,main = "Visualizing data\n(True clusters)",
     col = c("black", "blue", "red", "yellow", "green", "orange", "cyan")[cell_types])
legend("bottomleft", legend = cell_type_names,
       fill = c("black", "blue", "red", "yellow", "green", "orange", "cyan"), bty = "n")
```
...
```{r}
plot(tsne.out$Y[,1],tsne.out$Y[,2], xlab = "tSNE_1", ylab = "tSNE_2",type = "p", pch = 16,main = "Visualizing data\n(True clusters)",
     col = c("black", "blue", "red", "yellow", "green", "orange", "cyan")[cell_types])
legend("topright", legend = cell_type_names,
       fill = c("black", "blue", "red", "yellow", "green", "orange", "cyan"), bty = "n")
```
...
hier_clust_df %>% 
  ...
  filter(pca == min(pca) | spca == min(spca) | tsne == min(tsne))
```
